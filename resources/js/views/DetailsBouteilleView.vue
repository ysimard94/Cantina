<template>
    <div v-if="afficherTemplate" class="p-4 sm:p-6 md:p-8 max-w-5xl">
        <button
            @click="$router.go(-1)"
        ...
        <section
            class="grid grid-cols-1 md:grid-cols-2 gap- items-center relative my-4"
        >
            ...
            <h1 class="text-xl md:text-4xl font-bold text-vin-rouge mb-4">
                {{ bouteille.nom }}
            </h1>

            <div class="p-3">
                <div
                    class="flex justify-between items-center mb-4 border-b border-gray-300 pb-4"
                >
                    <span
                        class="material-symbols-outlined w-10 h-10 rounded-lg text-vin-rouge text-3xl"
                        >flag</span
                    >
                    <p class="text-lg lg:text-xl text-gray-900 font-bold ml-2">
                    ...
                    >
                    <p
                        class="text-lg lg:text-xl text-gray-900 font-bold ml-2 flex-grow-0 w-20"
                    >
