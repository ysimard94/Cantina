<template>
    <div class="mx-auto my-5 max-w-md ml-4 mr-4">
        <div class="bg-bg-rose rounded-lg shadow-lg p-4 sm:p-6">
            <h1 class="text-xl font-medium mb-4 sm:text-3xl">
                Ajouter un nouveau cellier
            </h1>
            <div
                v-if="succesMessage"
                class="bg-green-100 text-green-700 p-2 mt-4 rounded"
            >
                {{ succesMessage }}
            </div>
            <form @submit.prevent="ajouterCellier">
                <div class="mb-2 sm:mb-4">
                    <label
                        class="block text-gray-700 font-medium mb-1 text-sm sm:text-lg"
                        >Nom du cellier</label
                    >
                    <input
                        type="text"
