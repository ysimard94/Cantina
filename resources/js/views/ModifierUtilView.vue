        ...
        <div class="bg-bg-rose m-4 p-3 shadow-md rounded">
            <form @submit.prevent="editUtilisateur">
                ...
                <div class="mb-4">
                    ...
                    <p v-if="v$.mdp.$error" class="block text-md text-vin-rouge">Entrez l'ancien mot de passe</p>
                </div>
                <div class="mb-4">
                    <label for="conf-mdp" class="block text-lg text-left font-bold text-vin-rouge">Nouveau Mot de passe</label>
                    <input type="password" v-model="mdp_nouveau" id="conf-mdp" class="w-full rounded pt-2 pb-2 pl-1 pr-1">
                    <p v-if="v$.conf_mdp.$error" class="block text-md text-vin-rouge">Entrez un mot de passe valide</p>
                </div>
                <div>
...
export default {
    ...
    validations(){
        return {
            ...
            mdb_courant: minLength(3),
            mdp_nouveau: minLength(3)
        }
    },
    methods: {
