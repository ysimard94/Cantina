<template>
    <div class="bg-gray-100 p-4 rounded-lg min-w-0">
        <div class="mt-4">
          ...
          <!-- Liste des avis -->
            <div v-for="review in avis.slice(0, limit)" :key="review.id" class="bg-white rounded-lg shadow p-4 mb-4 text-left">
            ...
            <button v-if="limit < avis.length" class="bg-vin-rouge text-white px-4 py-2 rounded-lg mb-2" @click="limit += 3">
                Voir plus
                </button>
