<template>
    <div class="bg-bg_rose flex flex-col overflow-hidden shadow rounded-lg h-full mx-2" v-for="bouteille in bouteilles"
        :key="bouteille.id">
        <div class="flex items-start">
            <div class="w-1/3">
                <div class="relative">
                    <div class="text-center text-white font-bolder font-sans p-1"
                        :class="categorieBgColor(bouteille.categorie.nom)">
                        {{ bouteille.categorie.nom }}
                    </div>
                    <img :src="imageUrl(bouteille)" :alt="bouteille.nom" class="w-2/3 mt-4 mb-4 mx-auto" />
                </div>
            </div>
                ...
                <div class="text-sm mt-auto">
                    ...
                    <div>
                        <div class="pb-2 font-sans flex justify-end mt-1">
                            <router-link v-if="!bouteille.code_saq" @click="modifierBouteille(bouteille)"
                            ...
                            <button @click="supprimerBouteille(bouteille);"
                                ...
                                <span class="transform transition-all duration-500"
                                    :class="{ 'material-symbols-outlined rotate-45': bouteille.animationSupprimer }">
                                    wine_bar
                                </span>
                            </button>
                        </div>
