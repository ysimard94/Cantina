<template>
    <footer class="bg-vin-rouge bottom-0 w-full fixed h-50">
            ...
            <div class="flex justify-around" v-if="estConnecter">
                ...
                <button
                    ...
                    @click="
                        afficherRecherche();
                        fermerMenu();
                        changerPageActive(pageActive === 4 ? -1 : pageActive);
                    "
                >
                    add
                </button>
