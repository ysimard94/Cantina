            ...
            <div class="flex justify-around" v-if="estConnecter">
                <router-link class="w-full" :to="{ name: 'mes-celliers' }">
                    <button :class="{ 'actif': pageActive === 0 }"
                        ...
                        @click="fermerMenu(); fermerRecherche(); changerPageActive(0)">
                        home
                    </button>
                </router-link>
                <router-link class="w-full" :to="{ name: 'modifier-utilisateur' }">
                    <button :class="{ 'actif': pageActive === 1 }"
                        class="material-symbols-outlined text-white text-2xl px-5 py-3 w-full"
                        @click=" fermerMenu(); fermerRecherche(); changerPageActive(1)">
                        account_circle
                    </button>
                </router-link>
                ...
                <button 
                    :class="{ 
                        'bg-gray-700 rotate-45': pageActive === 2,
                        'bg-vin-blanc': pageActive !== 2,
                    }"
                    ...
                    @click="afficherRecherche(); changerPageActive(pageActive === 2 || pageActive === 4 ? -1 : 2)">
                    add
                </button>
                ...
                >
                    <button :class="{ 'actif': pageActive === 3 }"
                        class="material-symbols-outlined text-white text-2xl px-5 py-3 w-full"
                        @click=" fermerMenu(); fermerRecherche(); changerPageActive(3)">
                        menu_book
                    </button>
                </router-link>
